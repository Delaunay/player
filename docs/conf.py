...
# -*- coding: utf-8 -*-
"""
player documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'player'))
...
project = u'player'
_full_version = player.__version__
author = player.__author__
copyright = player.__copyright__
...
latex_documents = [
    (master_doc, 'player.tex', u'player Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'player', 'player Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'player', 'player Documentation',
     author, 'player', player.__descr__,
     'Miscellaneous'),
]
